...
define dso_local i32 @EXEC(i32 noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  ...
  %8 = sub nsw i32 %7, 1
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @exec_var, i64 0, i64 %9
...
12:                                               ; preds = %11
  ...
  %21 = call i32 @EXEC(i32 noundef %19, i32 noundef 1, i32 noundef %20)
  %22 = icmp ne i32 %21, 0
...
24:                                               ; preds = %23
  ...
  %38 = load i32, i32* %7, align 4
  %39 = call i32 @EXEC(i32 noundef %37, i32 noundef 2, i32 noundef %38)
  %40 = icmp ne i32 %39, 0
...
44:                                               ; preds = %43
  ...
  %55 = call i32 @EXEC(i32 noundef %49, i32 noundef 3, i32 noundef %54)
  br label %115
...
56:                                               ; preds = %41
  ...
  %66 = call i32 @EXEC(i32 noundef %64, i32 noundef 4, i32 noundef %65)
  %67 = icmp ne i32 %66, 0
...
69:                                               ; preds = %68
  ...
  %84 = call i32 @EXEC(i32 noundef %82, i32 noundef 5, i32 noundef %83)
  br label %114
...
86:                                               ; preds = %85
  ...
  %101 = call i32 @EXEC(i32 noundef %99, i32 noundef 6, i32 noundef %100)
  br label %102
...
102:                                              ; preds = %86
  ...
  %112 = load i32, i32* %7, align 4
  %113 = call i32 @EXEC(i32 noundef %107, i32 noundef 7, i32 noundef %112)
  br label %114
...
115:                                              ; preds = %114, %44
  ...
  %132 = call i32 @EXEC(i32 noundef %126, i32 noundef 8, i32 noundef %131)
  br label %133
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %6, i8* align 16 bitcast ([8 x i32]* @__const.main.a to i8*), i64 32, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([8 x i32]* @__const.main.c to i8*), i64 32, i1 false)
  ...
  call void @zsy_test2(i32* noundef %9, i32* noundef %10, i32* noundef %11)
  %12 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0))
  %13 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 0
  call void @print_arr(i32* noundef %13, i32 noundef 8)
  store i32 0, i32* %5, align 4
  br label %14
...
17:                                               ; preds = %14
  %18 = load i32, i32* %5, align 4
  %19 = add nsw i32 %18, 1
  %20 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32 noundef %19)
  %21 = load i32, i32* %5, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @exec_var, i64 0, i64 %22
  %24 = getelementptr inbounds [8 x i32], [8 x i32]* %23, i64 0, i64 0
  call void @print_arr(i32* noundef %24, i32 noundef 8)
  br label %25
